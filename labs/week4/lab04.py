...
#Lab04 - Q5 
print("You found a loot bag!! Look inside to find two items")
...
print("You see the monster in the distance! Use your first item from your belt")
first_item = belt.pop()
if first_item in good_loot_options:
    ...
    print("Your used " + first_item + " but its not helpful")
