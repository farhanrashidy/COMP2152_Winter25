...
def use_loot(belt, health_options):
    good_loot_options = ["Health Potions", "Leather Boots"]
    ...
    if first_item in good_loot_options:
        ...
        print("You use " + first_item + "and toue health is " + str(health_options))
    elif first_item in bad_loot_options:
        health_options = max(20, (health_options - 2))
        print("You use " + first_item + " and your health is " + str(health_options))
    else:
